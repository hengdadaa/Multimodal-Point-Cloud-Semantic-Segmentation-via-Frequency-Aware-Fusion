...
from network.n2p import N2PAttention
...
class SPVBlock(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        edge_features = self.n2p_attention(data_dict['sparse_tensor'].features)

        # point encoder
        p_fea = self.p_enc(
            features=data_dict['sparse_tensor'].features+v_fea.features+ edge_features,
            data_dict=data_dict
        )
